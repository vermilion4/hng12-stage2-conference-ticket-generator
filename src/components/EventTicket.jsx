    ...
    <div className="max-w-md mx-auto font-roboto">
      ...
      <div className="absolute top-0 z-10 left-0 w-full h-[30vh] bg-[radial-gradient(ellipse_at_top_center,rgba(36,160,181,0.3)_0%,rgba(36,160,181,0)_70%)]" />
        ...
        <div className="absolute -top-[2px] -left-[2px] w-8 h-8">
          ...
          <div className={`absolute w-[28px] h-[25px] -top-[2px] -left-[2px] ${isStep ? 'bg-greentwo' : 'bg-[#02191D]'} rounded-2xl border-r-0 -rotate-45 border-b-2 border-greenone`} />
        </div>
        <div className="absolute -top-[2px] -right-[2px] w-8 h-8">
          <div className="absolute w-full h-full bg-[#072C31] rounded-full" />
          <div className={`absolute w-[28px] h-[25px] -top-[2px] -right-[2px] ${isStep ? 'bg-greentwo' : 'bg-[#02191D]'} rounded-2xl border-l-0 rotate-45 border-b-2 border-greenone`} />
        </div>
        ...
        <div className="absolute -bottom-[2px] -left-[2px] w-8 h-4 overflow-hidden">
          <div className={`absolute w-8 h-8 -bottom-4 -left-0 ${isStep ? 'bg-greentwo' : 'bg-[#02191D]'} rounded-full border-2 border-greenone`} />
          <div className={`absolute w-8 h-8 -bottom-5 -left-2 ${isStep ? 'bg-greentwo' : 'bg-[#02191D]'} rounded-full`} />
        </div>
        <div className="absolute -bottom-[2px] -right-[2px] w-8 h-4 overflow-hidden">
          <div className={`absolute w-8 h-8 -bottom-4 -right-0 ${isStep ? 'bg-greentwo' : 'bg-[#02191D]'} rounded-full border-2 border-greenone`} />
          <div className={`absolute w-8 h-8 -bottom-5 -right-2 ${isStep ? 'bg-greentwo' : 'bg-[#02191D]'}  rounded-full`} />
        </div>  
      </div>
        {/* Tear line */}
      ...
      <div className="bg-[#072C31] border-t-0 p-6 relative border-2 border-greenone rounded-[20px]">
        ...
        <div className="absolute -top-[2px] -left-[2px] w-8 h-4 overflow-hidden">
          <div className={`absolute w-8 h-8 -top-4 -left-0 ${isStep ? 'bg-greentwo' : 'bg-[#02191D]'} rounded-full border-2 border-greenone`} />
          <div className={`absolute w-8 h-8 -top-5 -left-2 ${isStep ? 'bg-greentwo' : 'bg-[#02191D]'}  rounded-full`} />
        </div>

        {/* Right circle decoration */}
        <div className="absolute -top-[2px] -right-[2px] w-8 h-4 overflow-hidden">
          <div className={`absolute w-8 h-8 -top-4 -right-0 ${isStep ? 'bg-greentwo' : 'bg-[#02191D]'} rounded-full border-2 border-greenone`} />
          <div className={`absolute w-8 h-8 -top-5 -right-2 ${isStep ? 'bg-greentwo' : 'bg-[#02191D]'} rounded-full`} />
        </div>
        ...
        <div className="absolute -bottom-[2px] -left-[2px] w-8 h-8">
          <div className="absolute w-full h-full bg-[#072C31] rounded-full" />
          <div className={`absolute w-[28px] h-[25px] -bottom-[2px] -left-[2px] ${isStep ? 'bg-greentwo' : 'bg-[#02191D]'} rounded-2xl border-r-0 rotate-45 border-t-2 border-greenone`} />
        </div>
        <div className="absolute -bottom-[2px] -right-[2px] w-8 h-8">
          <div className="absolute w-full h-full bg-[#072C31] rounded-full" />
          <div className={`absolute w-[28px] h-[25px] -bottom-[2px] -right-[2px] ${isStep ? 'bg-greentwo' : 'bg-[#02191D]'} rounded-2xl border-l-0 -rotate-45 border-t-2 border-greenone`} />
        </div>
      </div>
    </div>
  );
